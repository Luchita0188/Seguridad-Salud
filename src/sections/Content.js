...
import {
  Cover, Page1, Page2, Page3, Page4, Page5, Page6, Page7, Page8, Page9, Page10, Page11, Page12, Page13,
} from './pages/Pages';
...
class Content extends Component {
  showContent = () => {
    ...
    switch (actualIndex) {
      ...
      case 7: return( <Page7 dataPage = { data.page7 } endActivities = { endActivities[7] }/>);
      ...
      case 11: return( <Page11 dataPage = { data.page11 } startQuiz = { clickNavigation } />);

      case 12: return( <Page12 dataPage = { data.page12 } endActivities = { endActivities[12] } checkEndActivity = { checkEndActivity } setScore = { setScore } endQuiz = { clickNavigation} />);

      // END --------------------------------------------------------------------------------
      case 13: return( <Page13 dataPage = { data.page13 } calificacion = { calificacion } /> );
